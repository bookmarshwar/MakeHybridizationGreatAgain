...
@Mod(
    ...
    name = "MakeHybridizationGreatAgain",
...
public class MakeHybridizationGreatAgain {
    ...
    @SidedProxy(
        clientSide = "com.folk.MakeHybridizationGreatAgain.ClientProxy",
        serverSide = "com.folk.MakeHybridizationGreatAgain.CommonProxy")
