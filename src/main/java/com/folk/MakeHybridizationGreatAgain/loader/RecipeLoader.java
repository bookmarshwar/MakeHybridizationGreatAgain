...
public class RecipeLoader {
    ...
    public static final RecipeMetadataKey<CrossingMode> CROSSING_MODE = new RecipeMetadataKey<CrossingMode>(
        CrossingMode.class,
        "crossing_mode") {
    ...
    static {
        AutomatedBreedingFacility = RecipeMapBuilder.of("AutomatedBreedingFacility")
            .maxIO(1, 1, 0, 0) // 最大 1 个物品输入，1 个物品输出，无流体
    ...
    public static void addRecipes() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 1, (byte) 1, (byte) 1, (byte) 4))
            .itemOutputs(
                ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 1, (byte) 1, (byte) 2, (byte) 4))
            .eut(1024L)
            .duration(100)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 1, (byte) 1, (byte) 1, (byte) 4))
            .itemOutputs(
                ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 1, (byte) 2, (byte) 1, (byte) 4))
            .eut(1024L)
            .duration(100)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 1, (byte) 1, (byte) 1, (byte) 4))
            .itemOutputs(
                ItemCropSeed.generateItemStackFromValues(IC2Crops.weed, (byte) 2, (byte) 1, (byte) 1, (byte) 4))
            .eut(1024L)
            .duration(100)
