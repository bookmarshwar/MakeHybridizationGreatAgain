...
import static com.folk.MakeHybridizationGreatAgain.MakeHybridizationGreatAgain.isInDevMode;
...
public final class Utils {
    ...
    public static ItemStack setStackSize(ItemStack itemStack, int amount) {
        ...
        if (amount < 0) {
            MakeHybridizationGreatAgain.LOG
    ...
    public static void debugLogInfo(String... strings) {
        if (isInDevMode) {
            for (String msg : strings) {
                MakeHybridizationGreatAgain.LOG.info(msg);
            }
        }
    }
